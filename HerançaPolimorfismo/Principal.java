/* Crie um programa em Java que implemente quatro classes: Imovel, Casa, Predio e Principal.

A classe Imovel possui dois atributos privados: areaConstruida do tipo double e endereço do tipo String. 
...
A classe Casa estende a classe Imovel e não possui qualquer atributo adicional.

A classe Predio estende a classe Imovel e possui um atributo privado adicional do tipo inteiro: andares.

As classes Imovel, Casa e Predio devem implementar os métodos hashCode e equals.

A classe Principal possui um método main que mantém um vetor de 10 Imóveis. Esse método ainda instancia três 
